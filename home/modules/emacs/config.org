...
(use-package dired+
  ...
  (tmacs-bind-leader-local
    ...
    "?" '(diredp-dired-plus-help :wk "help")))
#+end_src
* UI
** Defaults
#+begin_src emacs-lisp
...
** =ui-hydra=
#+begin_src emacs-lisp
(use-package ui-hydra
  :general
  (tmacs/bind-leader
    "u" '(ui-hydra/body :wk "UI"))
  :config
  (setq ui-hydra-theme-default 'dark
        ui-hydra-font-height-default 100
        ui-hydra-theme-auto-mode nil
        ui-hydra-font-selected "DejaVu Sans Mono for Powerline"
        ui-hydra-font-enabled-list '("DejaVu Sans Mono for Powerline"
